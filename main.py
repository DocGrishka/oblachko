...
cities = {
    'москва': ['1540737/073a30c505eb5c28a6b0', '213044/3562c1d206829b2d1f8e'],
    'нью-йорк': ['213044/406984958b063d25d0e3', '1652229/4c4ae6c82fc276440024'],
    'париж': ["1540737/bccf751fd44994cceda3", '1652229/52684001c2bf9aa79998']
}
...
def play_game(res, req):
    ...
    if attempt == 1:
        ...
        if 'помощь' in req['request']['nlu']['tokens']:
            res['response']['text'] = 'Эта игра называется Угадай город.\n' \
                                    'Вы должны угадать город по картинке.'
        elif sessionStorage[user_id]['city'] == 'country':
            ...
            if get_country(req) == country:
                ...
                res['response']['buttons'] = [
                    ...
                    },
                    {
                        'title': 'Покажи город на карте',
                        'hide': True,
                        'url': 'https://yandex.ru/maps/?mode=search&text=' + sessionStorage[user_id]['city']
                    }
                ]
            else:
            ...
            if get_city(req) == city:
                ...
                sessionStorage[user_id]['city'] = 'country'
                return
            else:
                if attempt == 3:
